...
export const APP_NAME_DEFAULT = "Papelería Nova" as const;

/** Entorno por defecto. */
export const APP_ENV_DEFAULT = "development" as const;

/** Contacto por defecto (fallback si VITE_CONTACT_EMAIL no existe). */
export const APP_CONTACT_EMAIL_DEFAULT = "hola@papelerianova.example" as const;

/** Idioma base del proyecto. Futuro para i18n. */
export const APP_LOCALE_DEFAULT = "es-ES" as const;
