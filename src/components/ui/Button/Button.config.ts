...
export const BUTTON_VARIANTS = {
  primary: "bg-primary text-secondary hover:bg-primary/90 active:bg-primary/80 rounded-12",
  secondary:
    "bg-secondary text-primary border border-primary hover:bg-primary/5 active:bg-primary/10 rounded-12",
  ghost: "bg-transparent text-primary hover:bg-primary/5 active:bg-primary/10 rounded-12",
} as const;
